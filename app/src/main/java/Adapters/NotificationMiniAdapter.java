 ...
 */
public class NotificationMiniAdapter extends ArrayAdapter<NotificationObject>{

	private final Context mycontext;
	private final ArrayList<NotificationObject> notifObjects;


	public NotificationMiniAdapter(Context mycontext, ArrayList<NotificationObject> testObjects) {
